...
public class FirstTaskModernForV1 {

	
		static // Create a new chrome web driver
		WebDriver driver;
		...
		public void Check(String browserName)
		{
			...
			public static void ultraFastTest(WebDriver driver, Eyes eyes) {
